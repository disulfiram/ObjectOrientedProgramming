...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        //The Engine class has a hardoded sleep time (search for 
        //"System.Threading.Sleep(500)"). Make the sleep time a field in 
        //the Engine and implement a constructor, whic takes it as an 
        ...
        {
            //Search for a "TODO" comment in the Engine class, regarding 
            //the AddRacket method. Solve the problem mentioned there.
